...
public class UserService {
    ...
    // not using this we can directly use @Slf4j annotation for class itself
    ...
    public boolean saveNewUser(User user){
        try {
            ...
            throw new UserCreationException("Error occurred while saving the user: " + e.getMessage(), e);
        }
    }

    // void type return , to use try catch option in createUser function in PublicController class
